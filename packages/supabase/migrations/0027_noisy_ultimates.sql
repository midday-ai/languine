ALTER TABLE `translations` RENAME COLUMN "type" TO "source_file";--> statement-breakpoint
...
ALTER TABLE `translations` ALTER COLUMN "source_file" TO "source_file" text NOT NULL;--> statement-breakpoint
...
ALTER TABLE `translations` ADD `source_type` text DEFAULT 'key' NOT NULL;