export default {
  ...
  login: {
    ...
    description: "Kirjaudu sisään aloittaaksesi lokalisoinnin automatisointi sekunneissa.",
    terms: {
  ...
  createProject: {
    ...
    createProjectButton: "Luo projekti",
    cancel: "Peruuta",
    createProjectDescription: "Luo uusi projekti aloittaaksesi lokalisoinnin automatisointi."
  },
  invite: {
