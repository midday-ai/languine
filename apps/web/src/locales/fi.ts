export default {
  test2: "Testataan kääntämistä Languinella",
  header: {
    pricing: "Hinnasto",
    docs: "Dokumentaatio",
  ...
  features: {
    ...
    fullyOpenSourceDescription: "Koodimme on julkisesti saatavilla GitHubissa, mahdollistaen läpinäkyvyyden ja yhteisön panokset.",
  ...
  login: {
    ...
    description: "Kirjaudu sisään aloittaaksesi lokalisointisi automatisointi sekunneissa.",
    terms: {
  ...
  account: {
    ...
    apiKey: {
      title: "API-avain",
      description: "Henkilökohtainen API-avain Languine API:n ja CLI:n käyttöön."
    },
    deleteAccount: {
      title: "Poista tili",
      description: "Poista tilisi ja kaikki siihen liittyvät tiedot pysyvästi. Tätä toimintoa ei voi peruuttaa.",
      button: "Poista tili"
    }
  },
  copyInstall: {
  ...
  pipeline: {
    ...
    pro: "[pro]",
    description: "Käännösmoottorimme integroituu saumattomasti olemassa olevaan CI/CD-putkistoosi, kääntäen koodipohjasi automaattisesti jokaisella push-toiminnolla. Kun koodimuutoksia työnnetään, analysoimme muokatun sisällön, ylläpidämme käännösmuistiasi ja luomme tarkkoja käännöksiä säilyttäen brändin äänen ja terminologian. Käännökset lähetetään sitten pull-pyyntöinä, jolloin ne voidaan tarkistaa ennen kuin ne yhdistetään päähaaraan ja otetaan käyttöön. Tämä automatisoitu työnkulku varmistaa, että lokalisoitu sisältö pysyy synkassa kehityksen kanssa."
  },
  settings: {
  ...
  tuning: {
    ...
    toneOfVoice: {
      title: "Sävyn sävy",
      description: "Määrittele käännöksissä käytettävä sävy",
      options: {
        casual: "Rentoutunut",
        formal: "Muodollinen",
    ...
    brand: "Brändi",
    emotiveIntent: {
      title: "Tunnetarkoitus",
      description: "Aseta tunnetaso käännöksille",
      options: {
        neutral: "Neutraali",
    ...
    domainExpertise: {
      title: "Alaosaaminen",
      description: "Määrittele käännösten alayhteys",
      options: {
        general: "Yleinen",
        technical: "Tekninen",
  ...
  createProject: {
    ...
    createProjectButton: "Luo projekti",
    cancel: "Peruuta",
    createProjectDescription: "Luo uusi projekti aloittaaksesi lokalisointisi automatisointi."
  },
  invite: {
  ...
  onboarding: {
    steps: {
      ...
      "3": {
        title: "Dokumentaatio",
        description: "Tutustu dokumentaatioomme yksityiskohtaisia ohjeita ja parhaita käytäntöjä varten",
        link: "dokumentaatio"
      }
    },
    info: {
  ...
  cli: {
    success: {
      ...
      description: "Languine CLI onnistuneesti todistettu käyttäjänä:",
