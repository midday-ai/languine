export default {
  ...
  features: {
    ...
    fullyOpenSourceDescription: "Il nostro codice è pubblicamente disponibile su GitHub, permettendo trasparenza e contributi della comunità.",
    noVendorLockIn: "Nessun vincolo di fornitore",
    noVendorLockInDescription: "Non ti blocchiamo in un servizio specifico, usa i tuoi LLM.",
    presetsForExpo: "Preset per Expo",
    presetsForExpoDescription: "Forniamo preset per Expo, così puoi iniziare rapidamente.",
    presetForReactNative: "Preset per React Native",
    presetForReactNativeDescription: "Forniamo un preset per React Native, così puoi iniziare rapidamente.",
  ...
  info: {
    ...
    implementation: {
      ...
      fileFormat: "Gestione del formato dei file",
  ...
  account: {
    ...
    deleteAccount: {
      ...
      description: "Elimina definitivamente il tuo account e tutti i dati associati. Questa azione non può essere annullata.",
  ...
  dangerZone: {
    dialog: {
      ...
      description: "Questa azione non può essere annullata. Digita DELETE per confermare.",
  ...
  pipeline: {
    ...
    pro: "[pro]",
    description: "Il nostro motore di traduzione si integra perfettamente nella tua pipeline CI/CD esistente, traducendo automaticamente il tuo codice ad ogni push. Quando vengono effettuate modifiche al codice, analizziamo il contenuto modificato, manteniamo la tua memoria di traduzione e generiamo traduzioni accurate preservando la voce del brand e la terminologia. Le traduzioni vengono quindi inviate come pull request, permettendo la revisione prima di essere unite nel tuo ramo principale e distribuite. Questo flusso di lavoro automatizzato assicura che i tuoi contenuti localizzati rimangano sincronizzati con lo sviluppo."
  },
  settings: {
    ...
    deleteTeamDescription: "Non puoi eliminare l'organizzazione quando sei l'unico membro, elimina invece il tuo account",
    ...
    provider: {
      ...
      translationProvider: {
        ...
        description: "Scegli il servizio AI preferito per generare traduzioni. Ogni fornitore offre diverse capacità e prezzi.",
        placeholder: "Seleziona un fornitore"
      },
      languageModel: {
        title: "Modello linguistico",
        description: "Seleziona il modello AI che bilancia meglio qualità e velocità per le tue esigenze di traduzione. Modelli più potenti possono essere più lenti ma producono risultati migliori.",
        placeholder: "Seleziona un modello"
      },
      apiKey: {
        title: "Chiave API del fornitore",
        description: "Inserisci la tua chiave API per autenticarti con il fornitore scelto. Mantieni questa chiave sicura - la crittiamo prima di memorizzarla.",
    ...
    project: {
      ...
      "delete": {
        ...
        description: "Elimina definitivamente questo progetto e tutti i suoi dati",
    ...
    team: {
      ...
      apiKey: {
        ...
        description: "Chiave API per l'accesso del team, usala dalla tua pipeline CI/CD insieme all'ID progetto",
  ...
  tuning: {
    ...
    translationMemory: {
      ...
      description: "Usa la memoria di traduzione per migliorare la coerenza e l'efficienza"
    },
    qualityChecks: {
    ...
    inclusiveLanguage: {
      ...
      description: "Assicura che le traduzioni utilizzino un linguaggio inclusivo"
    },
    formality: {
      title: "Formalità",
  ...
  invite: {
    ...
    inviteDescription: "Invita un membro al tuo team",
    emailLabel: "Email",
  ...
  onboarding: {
    steps: {
      "1": {
        title: "Configura CLI Languine",
        description: "Installa e configura la CLI Languine per gestire le traduzioni"
      },
      "2": {
      ...
      "3": {
        ...
        description: "Consulta la nostra documentazione per guide dettagliate e migliori pratiche",
        link: "documentazione"
      }
    },
    info: {
  ...
  cli: {
    success: {
      title: "Accesso CLI Languine riuscito",
      description: "La CLI Languine è stata autenticata con successo come:",
  ...
  hero2: {
    title: "Localizzazione automatizzata per le tue applicazioni",
    description: "Ottimizza il tuo processo di localizzazione con un CLI e una pipeline potenziati dall'IA, progettati per automatizzare le traduzioni per gli sviluppatori."
  },
  language: {
    en: "Inglese",
    es: "Spagnolo",
