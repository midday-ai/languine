export default {
  ...
  features: {
    ...
    fullyOpenSourceDescription: "Il nostro codice è pubblicamente disponibile su GitHub, consentendo trasparenza e contributi della comunità.",
  ...
  coming_soon: {
    ...
    description: "Attualmente siamo in accesso anticipato. Contatta",
  ...
  pipeline: {
    ...
    pro: "[pro]",
    description: "Il nostro motore di traduzione si integra perfettamente nella tua pipeline CI/CD esistente, traducendo automaticamente il tuo codice base ad ogni push. Quando vengono effettuate modifiche al codice, analizziamo il contenuto modificato, manteniamo la memoria di traduzione e generiamo traduzioni accurate preservando la voce e la terminologia del tuo brand. Le traduzioni vengono quindi inviate come pull request, consentendo la revisione prima di essere unite nel tuo ramo principale e distribuite. Questo flusso di lavoro automatizzato garantisce che i tuoi contenuti localizzati rimangano sincronizzati con lo sviluppo."
  },
  settings: {
  ...
  tuning: {
    ...
    toneOfVoice: {
      title: "Tono di voce",
      description: "Definisci il tono usato nelle traduzioni",
      options: {
        casual: "Informale",
        formal: "Formale",
        friendly: "Amichevole",
    ...
    brand: "Brand",
    emotiveIntent: {
      title: "Intento emotivo",
      description: "Imposta il tono emotivo per le traduzioni",
      options: {
        neutral: "Neutro",
        positive: "Positivo",
        empathetic: "Empatico",
    ...
    domainExpertise: {
      title: "Competenza del dominio",
      description: "Specifica il contesto del dominio per le traduzioni",
      options: {
        general: "Generale",
        technical: "Tecnico",
        medical: "Medico",
