export default {
  ...
  settings: {
    ...
    team: {
      ...
      apiKey: {
        ...
        description: "Takım erişimi için API anahtarı, bunu Proje Kimliği ile birlikte CI/CD boru hattınızdan kullanın",
  ...
  tuning: {
    ...
    translationMemory: {
      ...
      description: "Çeviri belleğini kullanarak tutarlılığı ve verimliliği artırın"
    },
    qualityChecks: {
    ...
    brandName: {
      title: "Marka Adı",
      description: "Tutarlı kullanım için marka adınızı ayarlayın",
    ...
    toneOfVoice: {
      title: "Ses Tonu",
      description: "Çevirilerde kullanılan tonu tanımlayın",
      options: {
        casual: "Gündelik",
        formal: "Resmi",
        friendly: "Dostane",
    ...
    brand: "Marka",
    emotiveIntent: {
      title: "Duygusal Niyet",
      description: "Çeviriler için duygusal tonu ayarlayın",
      options: {
        neutral: "Tarafsız",
        positive: "Olumlu",
        empathetic: "Empatik",
    ...
    domainExpertise: {
      ...
      description: "Çeviriler için alan bağlamını belirtin",
      options: {
        general: "Genel",
        technical: "Teknik",
        medical: "Tıbbi",
  ...
  onboarding: {
    steps: {
      ...
      "2": {
        title: "Çevirileri İt",
        description: "Çevirilerin itilmesi bekleniyor"
      },
      "3": {
        title: "Belgeler",
        description: "Ayrıntılı rehberler ve en iyi uygulamalar için belgelerimize göz atın",
        link: "belgeler"
      }
    },
    info: {
      description: "Yardıma mı ihtiyacınız var? Ayrıntılı rehberler ve en iyi uygulamalar için",
      link: "belgeler",
