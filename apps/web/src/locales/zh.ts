export default {
  ...
  features: {
    ...
    noVendorLockInDescription: "我们不会将您锁定在特定服务中，使用您自己的LLMs。",
    ...
    readyForI18nLibraries: "准备好用于i18n库",
  ...
  settings: {
    ...
    team: {
      ...
      apiKey: {
        title: "团队API密钥",
        description: "用于团队访问的API密钥，与项目ID一起从您的CI/CD流水线中使用",
        placeholder: "团队API密钥"
      },
      members: {
        title: "成员",
