export default {
  ...
  "features.presetForReactEmailDescription": "Vi har opprettet et i18n-bibliotek for React Email.",
  ...
  "account.fullName.description": "Ditt fulle navn som det vil vises på plattformen.",
  ...
  "tuning.qualityChecks.description": "Aktiver automatiserte kvalitetssjekker for oversettelser",
  "tuning.contextDetection.title": "Kontekstgjenkjenning",
  "tuning.contextDetection.description": "Automatisk gjenkjenning og bevaring av kontekst i oversettelser",
  ...
  "tuning.idioms.description": "Håndter idiomatiske uttrykk på en hensiktsmessig måte",
  ...
  "onboarding.steps.3.description": "Sjekk ut dokumentasjonen vår for detaljerte guider og beste praksis",
  ...
  "cli.success.description": "Languine CLI ble autentisert som:",
  ...
  "tuning.formality.options.casual": "Uformell",
  "tuning.formality.options.formal": "Formell",
  "tuning.formality.options.neutral": "Nøytral",
  "tuning.toneOfVoice.title": "Tonemåte",
  "tuning.toneOfVoice.description": "Definer tonen som brukes i oversettelser",
  "tuning.toneOfVoice.options.casual": "Uformell",
  "tuning.toneOfVoice.options.formal": "Formell",
  "tuning.toneOfVoice.options.friendly": "Vennlig",
  "tuning.toneOfVoice.options.professional": "Profesjonell",
  "tuning.toneOfVoice.options.playful": "Lekende",
  "tuning.toneOfVoice.options.serious": "Alvorlig",
  "tuning.toneOfVoice.options.confident": "Selvsikker",
  "tuning.toneOfVoice.options.humble": "Ydmyk",
  "tuning.toneOfVoice.options.direct": "Direkte",
  "tuning.toneOfVoice.options.diplomatic": "Diplomatisk",
  "tuning.brand": "Merkevare",
  "tuning.emotiveIntent.title": "Emosjonell intensjon",
  "tuning.emotiveIntent.description": "Sett den emosjonelle tonen for oversettelser",
  "tuning.emotiveIntent.options.neutral": "Nøytral",
  "tuning.emotiveIntent.options.positive": "Positiv",
  "tuning.emotiveIntent.options.empathetic": "Empatisk",
  "tuning.emotiveIntent.options.professional": "Profesjonell",
  "tuning.emotiveIntent.options.friendly": "Vennlig",
  "tuning.emotiveIntent.options.enthusiastic": "Entusiastisk",
  "tuning.domainExpertise.title": "Domeneekspertise",
  "tuning.domainExpertise.description": "Spesifiser domenekonteksten for oversettelser",
  "tuning.domainExpertise.options.general": "Generelt",
  "tuning.domainExpertise.options.technical": "Teknisk",
  "tuning.domainExpertise.options.medical": "Medisinsk",
  "tuning.domainExpertise.options.legal": "Juridisk",
  "tuning.domainExpertise.options.financial": "Finansiell",
  "tuning.domainExpertise.options.marketing": "Markedsføring",
  "tuning.domainExpertise.options.academic": "Akademisk",
  "billing.title": "Fakturering",
  "activity.type.key": "Nøkkel",
