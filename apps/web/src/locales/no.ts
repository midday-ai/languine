export default {
  test2: "Tester å oversette med Languine",
  header: {
    pricing: "Priser",
    docs: "Dokumentasjon",
    signIn: "Logg inn",
  ...
  tuning: {
    ...
    qualityChecks: {
      ...
      description: "Aktiver automatiserte kvalitetssjekker for oversettelser"
    },
    contextDetection: {
      title: "Kontekstgjenkjenning",
      description: "Automatisk gjenkjenning og bevaring av kontekst i oversettelser"
    },
    ...
    idioms: {
      title: "Idiomer",
      description: "Håndter idiomatiske uttrykk på en hensiktsmessig måte"
    },
    terminology: {
      title: "Terminologi",
    ...
    toneOfVoice: {
      title: "Tonemåte",
      description: "Definer tonen som brukes i oversettelser",
      options: {
        casual: "Uformell",
        formal: "Formell",
        friendly: "Vennlig",
    ...
    brand: "Merkevare",
    emotiveIntent: {
      title: "Emosjonell intensjon",
      description: "Sett den emosjonelle tonen for oversettelser",
      options: {
        neutral: "Nøytral",
        positive: "Positiv",
        empathetic: "Empatisk",
    ...
    domainExpertise: {
      title: "Domeneekspertise",
      description: "Spesifiser domenekonteksten for oversettelser",
      options: {
        general: "Generelt",
        technical: "Teknisk",
        medical: "Medisinsk",
  ...
  onboarding: {
    steps: {
      ...
      "3": {
        title: "Dokumentasjon",
        description: "Sjekk ut dokumentasjonen vår for detaljerte guider og beste praksis",
        link: "dokumentasjon"
      }
    },
    info: {
