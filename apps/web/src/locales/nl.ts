export default {
  ...
  account: {
    ...
    deleteAccount: {
      ...
      description: "Verwijder uw account en alle bijbehorende gegevens permanent. Deze actie kan niet ongedaan worden gemaakt.",
  ...
  settings: {
    ...
    project: {
      ...
      id: {
        title: "Project-ID",
        description: "Uw unieke projectidentifier",
  ...
  tuning: {
    ...
    qualityChecks: {
      ...
      description: "Schakel geautomatiseerde kwaliteitscontroles in voor vertalingen"
    },
    contextDetection: {
      title: "Contextdetectie",
      description: "Detecteer en behoud context automatisch in vertalingen"
    },
    ...
    toneOfVoice: {
      title: "Toon van stem",
      description: "Definieer de toon die in vertalingen wordt gebruikt",
      options: {
        casual: "Informeel",
        formal: "Formeel",
    ...
    brand: "Merk",
    emotiveIntent: {
      title: "Emotionele intentie",
      description: "Stel de emotionele toon in voor vertalingen",
      options: {
        neutral: "Neutraal",
        positive: "Positief",
    ...
    domainExpertise: {
      title: "Domeinexpertise",
      description: "Specificeer de domeincontext voor vertalingen",
      options: {
        general: "Algemeen",
        technical: "Technisch",
        medical: "Medisch",
