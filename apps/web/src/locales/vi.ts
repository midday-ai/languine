export default {
  ...
  features: {
    ...
    presetsForExpoDescription: "Chúng tôi cung cấp cài đặt sẵn cho Expo, để bạn có thể bắt đầu nhanh chóng.",
    presetForReactNative: "Cài đặt sẵn cho React Native",
    presetForReactNativeDescription: "Chúng tôi cung cấp cài đặt sẵn cho React Native, để bạn có thể bắt đầu nhanh chóng.",
  ...
  settings: {
    ...
    team: {
      ...
      members: {
        ...
        deleteInviteSuccess: "Lời mời đã xóa",
  ...
  tuning: {
    ...
    toneOfVoice: {
      title: "Tông giọng",
      description: "Xác định tông giọng được sử dụng trong bản dịch",
      options: {
        casual: "Thân mật",
        formal: "Trang trọng",
        friendly: "Thân thiện",
    ...
    brand: "Thương hiệu",
    emotiveIntent: {
      title: "Ý định cảm xúc",
      description: "Đặt tông cảm xúc cho bản dịch",
      options: {
        neutral: "Trung lập",
        positive: "Tích cực",
        empathetic: "Đồng cảm",
    ...
    domainExpertise: {
      ...
      description: "Chỉ định ngữ cảnh lĩnh vực cho bản dịch",
      options: {
        general: "Chung",
        technical: "Kỹ thuật",
        medical: "Y tế",
