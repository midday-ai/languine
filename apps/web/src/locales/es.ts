export default {
  test2: "Probando la traducción con Languine",
  header: {
    pricing: "Precios",
    docs: "Documentación",
  ...
  account: {
    ...
    apiKey: {
      title: "Clave API",
      description: "Tu clave API personal para acceder a la API de Languine y desde la CLI."
    },
    deleteAccount: {
  ...
  settings: {
    ...
    team: {
      ...
      members: {
        ...
        removeMemberDescription: "¿Estás seguro de que deseas eliminar a este miembro?",
  ...
  tuning: {
    ...
    toneOfVoice: {
      title: "Tono de Voz",
      description: "Define el tono usado en las traducciones",
      options: {
        casual: "Casual",
        formal: "Formal",
        friendly: "Amigable",
    ...
    brand: "Marca",
    emotiveIntent: {
      title: "Intención Emotiva",
      description: "Establece el tono emocional para las traducciones",
      options: {
        neutral: "Neutral",
        positive: "Positivo",
        empathetic: "Empático",
    ...
    domainExpertise: {
      title: "Experiencia en el Dominio",
      description: "Especifica el contexto del dominio para las traducciones",
      options: {
        general: "General",
        technical: "Técnico",
        medical: "Médico",
  ...
  createProject: {
    ...
    createProjectButton: "Crear proyecto",
    cancel: "Cancelar",
    createProjectDescription: "Crea un nuevo proyecto para comenzar a automatizar tu localización."
  },
  invite: {
  ...
  faq: {
    ...
    cancel_subscription: {
      ...
      answer: "Puedes cancelar tu suscripción en cualquier momento desde la configuración de tu cuenta. Navega a Facturación > Cambiar Plan. Tu suscripción permanecerá activa hasta el final de tu período de facturación actual, después de lo cual serás movido al plan Gratis."
    }
  },
  pricing_slider: {
    tier: "Nivel {tier}",
