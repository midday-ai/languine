export default {
  ...
  features: {
    ...
    noVendorLockInDescription: "특정 서비스에 잠기지 않습니다, 자신의 LLM을 사용하세요.",
    ...
    presetForReactNativeDescription: "React Native를 위한 사전 설정을 제공하여 빠르게 시작할 수 있습니다.",
    presetForReactEmail: "React Email 라이브러리",
    presetForReactEmailDescription: "React Email을 위한 i18n 라이브러리를 만들었습니다.",
  ...
  login: {
    ...
    google: "Google로 로그인",
    footer: "현지화를 자동화하세요.",
    description: "로그인하여 몇 초 만에 현지화를 자동화하세요.",
    terms: {
  ...
  coming_soon: {
    ...
    cta: "우리는 현재 초기 접근 단계에 있습니다. 초기 접근을 얻으려면 X로 연락하세요."
  },
  account: {
    fullName: {
      title: "전체 이름",
      description: "플랫폼 전체에 표시될 전체 이름입니다.",
    ...
    apiKey: {
      title: "API 키",
      description: "Languine API 및 CLI에 접근하기 위한 개인 API 키입니다."
    },
    deleteAccount: {
      title: "계정 삭제",
      description: "계정 및 모든 관련 데이터를 영구적으로 삭제합니다. 이 작업은 취소할 수 없습니다.",
      button: "계정 삭제"
    }
  },
  copyInstall: {
  ...
  settings: {
    ...
    deleteTeamDescription: "유일한 멤버일 때 조직을 삭제할 수 없습니다, 대신 계정을 삭제하세요",
    error: "문제가 발생했습니다",
    errorDescription: "다시 시도하거나 지원팀에 문의하세요",
    addTeam: "팀 생성",
    apiKey: {
      updated: "API 키 업데이트됨",
      updatedDescription: "API 키가 성공적으로 업데이트되었으며 클립보드에 복사되었습니다.",
      title: "API 키 업데이트",
  ...
  tuning: {
    ...
    domainExpertise: {
      title: "도메인 전문성",
      description: "번역을 위한 도메인 컨텍스트 지정",
      options: {
        general: "일반",
        technical: "기술적인",
        medical: "의료",
  ...
  createProject: {
    ...
    cancel: "취소",
    createProjectDescription: "현지화를 자동화하기 위해 새 프로젝트를 생성하세요."
  },
  invite: {
    inviteMember: "멤버 초대",
    inviteDescription: "팀에 멤버 초대",
    emailLabel: "이메일",
  ...
  onboarding: {
    steps: {
      "1": {
        ...
        description: "번역을 관리하기 위해 Languine CLI 설치 및 구성"
      },
      "2": {
        title: "번역 푸시",
      ...
      "3": {
        title: "문서",
        description: "자세한 가이드와 모범 사례를 위해 문서를 확인하세요",
        link: "문서"
      }
    },
    info: {
      description: "도움이 필요하세요? 자세한 가이드와 모범 사례를 위해",
      link: "문서",
