export default {
  ...
  hero: {
    ...
    description:
      "Rationalisez votre processus de localisation avec une interface en ligne de commande alimentée par l'IA et un pipeline conçu pour automatiser les traductions pour les développeurs.",
  },
  getStarted: {
    heading: "Commencer",
    title: "Localisation automatisée pour vos applications",
  ...
  features: {
    ...
    noVendorLockInDescription:
      "Nous ne vous enfermons pas dans un service spécifique, utilisez vos propres LLM.",
    presetsForExpo: "Préréglages pour Expo",
    presetsForExpoDescription:
      "Nous fournissons des préréglages pour Expo, afin que vous puissiez commencer rapidement.",
    presetForReactNative: "Préréglage pour React Native",
    presetForReactNativeDescription:
      "Nous fournissons un préréglage pour React Native, afin que vous puissiez commencer rapidement.",
    ...
    readyForI18nLibrariesDescription:
      "Nous supportons toutes les bibliothèques, y compris les plus populaires (next-intl, react-i18next, react-intl, etc).",
  },
  info: {
    title:
      "Gère chaque aspect de la localisation de votre application, y compris",
    smartTranslation: {
      title: "Traduction intelligente",
      intelligentTranslation:
        "Traduction intelligente avec conscience du contexte",
  ...
  login: {
    ...
    description:
      "Connectez-vous pour commencer à automatiser votre localisation en quelques secondes.",
    terms: {
  ...
  account: {
    ...
    apiKey: {
      title: "Clé API",
      description:
        "Votre clé API personnelle pour accéder à l'API Languine et depuis l'interface en ligne de commande.",
    },
    deleteAccount: {
  ...
  dangerZone: {
    dialog: {
      ...
      description:
        "Cette action ne peut pas être annulée. Veuillez taper SUPPRIMER pour confirmer.",
  ...
  settings: {
    ...
    team: {
      ...
      apiKey: {
        ...
        description:
          "Clé API pour l'accès à l'équipe, utilisez ceci depuis votre pipeline CI/CD avec l'ID du projet",
    ...
    badRequestDescription:
      "L'organisation doit avoir au moins un propriétaire. Transférez la propriété à un autre membre avant de supprimer ce propriétaire.",
    permissionDenied: "Permission refusée",
    permissionDeniedDescription:
      "Vous devez être propriétaire de l'équipe pour effectuer cette action",
    deleteTeamTitle: "Supprimer l'équipe",
    deleteTeamDescription:
      "Impossible de supprimer l'organisation lorsque vous êtes le seul membre, supprimez plutôt votre compte",
    ...
    apiKey: {
      ...
      updatedDescription:
        "Votre clé API a été mise à jour avec succès et copiée dans votre presse-papiers.",
      title: "Mettre à jour la clé API",
      description:
        "Êtes-vous sûr de vouloir générer une nouvelle clé API ? L'ancienne clé cessera de fonctionner immédiatement.",
      cancel: "Annuler",
      continue: "Continuer",
    },
    provider: {
      ...
      translationProvider: {
        ...
        description:
          "Choisissez votre service d'IA préféré pour générer des traductions. Chaque fournisseur offre différentes capacités et tarifications.",
        placeholder: "Sélectionner un fournisseur",
      },
      languageModel: {
        title: "Modèle de langue",
        description:
          "Sélectionnez le modèle d'IA qui équilibre le mieux qualité et rapidité pour vos besoins de traduction. Des modèles plus puissants peuvent être plus lents mais produisent de meilleurs résultats.",
        placeholder: "Sélectionner un modèle",
      },
      apiKey: {
        title: "Clé API du fournisseur",
        description:
          "Entrez votre clé API pour vous authentifier auprès de votre fournisseur choisi. Gardez cette clé en sécurité - nous l'encryptons avant de la stocker.",
  ...
  tuning: {
    ...
    translationMemory: {
      ...
      description:
        "Utilisez la mémoire de traduction pour améliorer la cohérence et l'efficacité",
    },
    qualityChecks: {
      title: "Contrôles de qualité",
      description:
        "Activez les contrôles de qualité automatisés pour les traductions",
    },
    contextDetection: {
      title: "Détection de contexte",
      description:
        "Détectez et préservez automatiquement le contexte dans les traductions",
    },
    ...
    inclusiveLanguage: {
      ...
      description:
        "Assurez-vous que les traductions utilisent un langage inclusif",
    },
    formality: {
      title: "Formalité",
    ...
    brandName: {
      ...
      description:
        "Définissez le nom de votre marque pour une utilisation cohérente",
    ...
    culturalAdaptation: {
      ...
      description:
        "Adaptez le contenu pour qu'il soit culturellement approprié",
    },
  },
  pricing: {
  ...
  createTeam: {
    ...
    createTeamDescription:
      "Créer une nouvelle équipe pour gérer vos projets et collaborateurs.",
  },
  createProject: {
    createProjectTitle: "Créer un nouveau projet",
    ...
    createProjectDescription:
      "Créer un nouveau projet pour commencer à automatiser votre localisation.",
  },
  invite: {
    inviteMember: "Inviter un membre",
    inviteDescription: "Inviter un membre à votre équipe",
    emailLabel: "E-mail",
  ...
  onboarding: {
    steps: {
      "1": {
        ...
        description:
          "Installez et configurez Languine CLI pour gérer les traductions",
      },
      "2": {
      ...
      "3": {
        title: "Documentation",
        description:
          "Consultez notre documentation pour des guides détaillés et des meilleures pratiques",
        link: "documentation",
      },
    },
    info: {
  ...
  cli: {
    success: {
      title: "Connexion réussie Languine CLI",
      description: "Languine CLI a été authentifié avec succès en tant que :",
      description_2:
        "Vous pouvez maintenant fermer cet onglet et revenir à l'interface en ligne de commande",
    },
  },
} as const;
