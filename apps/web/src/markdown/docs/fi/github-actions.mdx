...
GitHub-toiminnolla voit helposti kääntää koodisi yksinkertaisesti työntämällä koodisi repositorioon, jolloin GitHub-toiminto kääntää uudet avaimet, luo pull-pyynnön tai sitoo muutoksesi.
...
1. Asetettava repositoriosi salaisuudet Languine-tunnuksillasi
2. Luotava työnkulku-tiedosto repositoriosi

### Repositorion salaisuuksien asettaminen
...
Voit löytää nämä arvot Languine-hallintapaneelista Projektin asetuksista.
...
```
 ...
 Tämä työnkulku:
- Suoritetaan päähaaraan työntämisessä
- Suoritetaan päähaaraan tehtävissä pull-pyynnöissä
