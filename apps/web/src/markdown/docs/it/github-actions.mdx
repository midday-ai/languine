...
Questo ti fa risparmiare molto tempo e sforzo mantenendo traduzioni di alta qualità.
...
L'opzione `working-directory` consente di specificare dove si trovano i tuoi file di traduzione. Questo è particolarmente utile nei monorepo dove le tue traduzioni possono trovarsi in un pacchetto o in una directory di app specifica. Ad esempio:
