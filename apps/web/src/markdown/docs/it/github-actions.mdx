...
Con l'azione di GitHub, puoi facilmente tradurre il tuo codice semplicemente caricando il tuo codice nel repository; l'azione di GitHub tradurrà quindi le tue nuove chiavi, creando una pull request o impegnando le tue modifiche.
...
Per utilizzare l'azione Languine di GitHub nel tuo repository, dovrai:
...
Puoi trovare questi valori nel tuo cruscotto Languine sotto Impostazioni Progetto.



### Variabili d'Ambiente

L'azione di GitHub utilizza le seguenti variabili d'ambiente:
...
- `GITHUB_TOKEN` (Obbligatoria): Fornita automaticamente da GitHub, utilizzata per creare PR
...
```
 ...
 Questo workflow:
- Eseguirà su push al ramo principale
- Eseguirà su pull request al ramo principale
- Può essere attivato manualmente dalla scheda Azioni
- Controlla il tuo codice e avvia il processo di traduzione Languine
