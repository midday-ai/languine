...
```
 ...
 Questo workflow:
- Verrà eseguito su push nel ramo principale
- Verrà eseguito su pull request nel ramo principale
...
L'opzione `working-directory` ti consente di specificare dove si trovano i tuoi file di traduzione. Questo è particolarmente utile nei monorepo dove le tue traduzioni possono trovarsi in un pacchetto o in una directory app specifica. Ad esempio:
...
- Invia le modifiche senza creare una pull request