...
Puoi trovare questi valori nella tua dashboard Languine sotto Impostazioni Progetto.
...
L'opzione `create-pull-request` controlla se l'azione crea una pull request con le modifiche o le impegna direttamente al ramo:
...
- Impegna le modifiche direttamente al ramo corrente
