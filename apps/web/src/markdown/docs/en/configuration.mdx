...
Languine supports both TypeScript and JSON configuration files to manage your translation setup. You can choose either languine.config.ts for TypeScript or languine.json for JSON format. Both files define your source and target languages, as well as the files that need to be translated.
...
5. **Project ID**: Keep your project ID secure and don't share it publicly if you're using cloud services
