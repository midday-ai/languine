...
For å bruke Languine GitHub-handlingen i depotet ditt, må du:
...
- Kjøres ved pushing til hovedgrenen
- Kjøres ved pull-forespørsel til hovedgrenen
...
Alternativet `working-directory` lar deg spesifisere hvor oversettelsesfilene dine er plassert. Dette er spesielt nyttig i monorepos der oversettelsene dine kan være i en spesifikk pakke eller app-katalog. For eksempel:
...
- Committe endringene direkte til den nåværende grenen
