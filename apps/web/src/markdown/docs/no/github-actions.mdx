...
Legg til følgende hemmeligheter i depotinnstillingene dine (Innstillinger > Hemmeligheter og variabler > Handlinger):
...
- Kjøres ved push til hovedgrenen
...
`working-directory`-alternativet lar deg spesifisere hvor oversettelsesfilene dine ligger. Dette er spesielt nyttig i monorepos der oversettelsene dine kan være i en spesifikk pakke eller app-katalog. For eksempel:

#### Pull Request-alternativ (kommer snart)
