...
1. Sette opp hemmeligheter for depotet med Languine-legitimasjonen din
...
`create-pull-request`-alternativet styrer om handlingen oppretter en pull request med endringene eller commiter dem direkte til grenen:
