...
- `GITHUB_TOKEN` (Requis) : Fournie automatiquement par GitHub, utilisée pour créer des PR
...
- Créer une demande de tirage avec toutes les nouvelles traductions (configurable)
