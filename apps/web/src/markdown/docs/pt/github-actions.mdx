...
Com a ação do GitHub, você pode traduzir seu código facilmente apenas enviando seu código para o repositório; a ação do GitHub então traduzirá suas novas chaves, criando um pull request ou confirmando suas alterações.
...
with:
  create-pull-request: true # cria um pull request com as alterações
```
