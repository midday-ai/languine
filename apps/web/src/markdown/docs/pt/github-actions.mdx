...
Com a ação do GitHub, você pode traduzir seu código facilmente apenas enviando seu código para o repositório; a ação do GitHub então traduz suas novas chaves, criando um pull request ou fazendo um commit das suas alterações.
...
```
 ...
 Este workflow irá:
- Executar em envios para o branch principal
- Executar em pull requests para o branch principal
...
A opção `create-pull-request` controla se a ação cria um pull request com as alterações ou as comita diretamente no branch:
