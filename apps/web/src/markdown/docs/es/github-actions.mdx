...
Con la acción de GitHub, puedes traducir fácilmente tu código simplemente al subirlo al repositorio; la acción de GitHub traducirá tus nuevas claves, ya sea creando una solicitud de extracción o confirmando tus cambios.
...
Para usar la acción de GitHub de Languine en tu repositorio, necesitarás:
