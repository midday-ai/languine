...
Con la acción de GitHub, puedes traducir tu código fácilmente simplemente al subirlo al repositorio; la acción de GitHub traducirá tus nuevas claves, ya sea creando una solicitud de extracción o confirmando tus cambios.
...
Para usar la acción de GitHub Languine en tu repositorio, necesitarás:
...
- `GITHUB_TOKEN` (Requerido): Proporcionado automáticamente por GitHub, utilizado para crear solicitudes de extracción
...
#### Opción de Solicitud de Extracción
...
- Agregará etiquetas y descripción apropiadas
