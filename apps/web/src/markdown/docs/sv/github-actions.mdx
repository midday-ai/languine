...
GitHub-actionen använder följande miljövariabler:
...
Alternativet `working-directory` låter dig specificera var dina översättningsfiler finns. Detta är särskilt användbart i monorepos där dina översättningar kan finnas i en specifik paket- eller appkatalog. Till exempel:

#### Pull-begäran alternativ (kommer snart)

Alternativet `create-pull-request` styr huruvida åtgärden skapar en pull-begäran med ändringarna eller begår dem direkt till grenen:
