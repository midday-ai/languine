...
Med GitHub-åtgärden kan du enkelt översätta din kod genom att bara trycka på din kod till lagret, så kommer GitHub-åtgärden att översätta dina nya nycklar, antingen skapa en pull-begäran eller begå dina ändringar.
...
GitHub-åtgärden använder följande miljövariabler:
...
- `GITHUB_TOKEN` (Obligatorisk): Tillhandahålls automatiskt av GitHub, används för att skapa PR:er
...
- Köras vid tryck på huvudgrenen
- Köras vid pull-begärningar till huvudgrenen
- Kan utlösas manuellt från Åtgärdstabben
- Checka ut din kod och köra Languine översättningsprocess
- Skapa en pull-begäran med eventuella nya översättningar (konfigurerbar)

#### Arbetskatalogalternativ

Alternativet `working-directory` gör att du kan specificera var dina översättningsfiler finns. Detta är särskilt användbart i monorepos där dina översättningar kan finnas i ett specifikt paket eller appkatalog. Till exempel:
