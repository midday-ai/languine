...
Med GitHub-åtgärden kan du enkelt översätta din kod genom att bara trycka på din kod till lagret, GitHub-åtgärden kommer då att översätta dina nya nycklar, antingen skapa en pull-begäran eller begå dina ändringar.
...
- Hämta din kod och köra Languine-översättningsprocessen
- Skapa en pull-begäran med eventuella nya översättningar (konfigurerbar)

#### Arbetskatalogalternativ

Alternativet `working-directory` låter dig specificera var dina översättningsfiler finns. Detta är särskilt användbart i monorepos där dina översättningar kan finnas i ett specifikt paket eller appkatalog. Till exempel:
