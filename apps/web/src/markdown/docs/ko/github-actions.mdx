...
GitHub Action을 사용하면 코드를 저장소에 푸시하기만 하면 쉽게 코드를 번역할 수 있습니다. GitHub Action은 새로운 키를 번역하고, 풀 리퀘스트를 생성하거나 변경 사항을 커밋합니다.
...
- `GITHUB_TOKEN` (필수): GitHub에서 자동으로 제공되며, PR 생성에 사용됩니다.

### 예제 워크플로

저장소에 다음 내용을 포함하는 새 파일 .github/workflows/languine.yml을 생성합니다:
