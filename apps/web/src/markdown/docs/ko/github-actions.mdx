...
github action을 사용하면 코드를 저장소에 푸시하기만 하면 쉽게 번역할 수 있습니다. github action은 새로운 키를 번역하고, 풀 리퀘스트를 생성하거나 변경 사항을 커밋합니다.
...
저장소에 .github/workflows/languine.yml라는 새 파일을 생성하고 다음 내용을 추가합니다:
