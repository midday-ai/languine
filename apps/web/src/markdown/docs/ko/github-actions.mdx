...
GitHub Action을 사용하면 코드를 저장소에 푸시하기만 하면 쉽게 번역할 수 있으며, GitHub Action은 새로운 키를 번역하고, 풀 리퀘스트를 생성하거나 변경 사항을 커밋합니다.
...
저장소에 다음 내용을 가진 .github/workflows/languine.yml 파일을 새로 생성합니다:
