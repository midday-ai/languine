...
Com a ação do GitHub, você pode facilmente traduzir seu código apenas enviando-o para o repositório; a ação do GitHub então traduz suas novas chaves, criando um pull request ou confirmando suas alterações.
...
```
 ...
 Este workflow irá:
- Executar em pushes para a branch principal
