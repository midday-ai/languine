...
1. Ustawić sekrety repozytorium z danymi logowania do Languine
...
- `LANGUINE_API_KEY` (Wymagane): Twój klucz API Languine do autoryzacji
...
- Utworzy pull request z nowymi tłumaczeniami (można skonfigurować)
