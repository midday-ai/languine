...
Dzięki akcji GitHub możesz łatwo przetłumaczyć swój kod, po prostu przesyłając go do repozytorium, a akcja GitHub przetłumaczy twoje nowe klucze, tworząc pull request lub zatwierdzając twoje zmiany.
...
1. Skonfigurować sekrety repozytorium z danymi uwierzytelniającymi Languine
...
```
 ...
 Ten przepływ roboczy:
- Będzie działał przy przesyłaniu do głównej gałęzi
- Będzie działał przy pull requestach do głównej gałęzi
